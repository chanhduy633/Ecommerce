            ...
            <nav>
                ...
                <div className="right">
                    ...
                    <div className="menu_div">
                        ...
                        >
                            <MenuItem onClick={handleClose} style={{ margin: 10 }}>Tài khoản cá nhân</MenuItem>
                            {account ? <MenuItem style={{ margin: 10 }} onClick={logoutuser} ><LogoutIcon style={{ fontSize: 16, marginRight: 3 }} />   Đăng xuất</MenuItem> : ""}
                        </Menu>
                    </div>
                    <ToastContainer />
                </div>
